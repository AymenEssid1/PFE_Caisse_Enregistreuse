...
export class SoldServices {
    private categoryUrl = ' http://localhost:8085/gateway/STOCK/categories';

    private soldUrl =' http://localhost:8085/gateway/STOCK/sold-products'
    ...
    addSoldProduct(establishmentId: number, soldProduct: any): Observable<SoldProduct> {
