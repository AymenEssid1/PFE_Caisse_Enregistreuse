...
public class EstablishmentController {
    ...
    public ResponseEntity<Tables> updateTableStatus(@PathVariable("id") Integer tableId, @RequestParam("status") Boolean status) {
        try {
            Tables updatedTable = establishmentService.updateTableStatus(tableId, status);
...
//voxw rwko ouhv xchn
    ...
    public ResponseEntity<Tables> getTablebyId(@PathVariable("id") Integer id) {
        try {
