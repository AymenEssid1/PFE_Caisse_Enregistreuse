...
public class StockProductController {
    ...
    @PostMapping("/check-stock-availability")
    public ResponseEntity<?> checkStockAvailability(@RequestBody List<StockEquivalent> stockEquivalents,
                                                    @RequestParam("quantity") float quantity) {
        boolean available = stockProductService.checkStockAvailability(stockEquivalents, quantity);
